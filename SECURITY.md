...
If you discover a security vulnerability in Anvil, please report it through GitHub's private vulnerability reporting feature:

1. Go to the [Security tab](https://github.com/kafkade/anvil/security) of this repository
